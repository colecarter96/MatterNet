      ...
      <div>
        ...
        <div className="pb-20 pt-32 relative">
          <div className="relative">
            <h1 className="font-roboto-mono text-8xl font-bold text-right pr-32 animate-slide-in">
            {/* <h1 className="font-roboto-mono text-8xl font-bold text-right pr-30"> */}
              TRACTION
            </h1>
          </div>
          <p className="font-rubik text-2xl ml-32 mr-[40%] pt-32"> 
        ...
        {/* // Card #2 (Clarity) */}
        <div className="pb-22 pt-32">
            <h1 className="font-roboto-mono text-8xl font-bold text-left pl-32 animate-typewriter">
                CLARITY
            </h1>
            <p className="font-rubik text-2xl mr-32 ml-[40%] pt-32">
        ...
        {/* // Card #3 (Credibility) */}
        <div className="pb-22 pt-32">
            <h1 className="font-roboto-mono text-8xl font-bold text-right pr-32 animate-credibility">
            {/* <h1 className="font-roboto-mono text-8xl font-bold text-right pr-30"> */}
              CREDIBILITY
            </h1>
            <p className="font-rubik text-2xl ml-32 mr-[40%] pt-32">
